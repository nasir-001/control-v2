  ...
  <div class="tw-mt-24">
    <div class="tw-text-center">
      ...
      <div class="tw-w-1/2 tw-mx-auto tw-pt-2">
        ...
        non-Muslim who wants to learn more about Islam, Chat Islam can provide
        you with the knowledge and resources you need to do so.
      </div>
    </div>
    <div class="tw-mt-12">
      <div class="row tw-justify-evenly">
        ...
        <div class="tw-w-1/4">
          ...
          <div class="tw-text-sm tw-text-gray-600">
            ...
            your own pace and on your own schedule. You can access course
        ...
        <div class="tw-w-1/4">
          ...
          <div class="tw-text-sm tw-text-gray-600">
            ...
            and preferences. You can choose your own learning path, interact
            with instructors a d mentors and receive real-time feedback on
            questions.
          </div>
        </div>
      </div>
      <div class="row tw-justify-evenly tw-mt-8">
        <div class="tw-w-1/4">
          ...
          <div class="tw-text-sm tw-text-gray-600">
            ...
            will connect with your peers, participate in group projects, and
        ...
        <div class="tw-w-1/4">
          ...
          <div class="tw-text-sm tw-text-gray-600">
            ...
            that can serve you throughout your career. By investing in your
            education. You will stay ahead of the curve and adapt to changing
            job market.
          </div>
        </div>
      </div>
...
<style scoped>
.title {
  background: linear-gradient(to right, #0b1e4f 0%, #fd8a45 100%);
